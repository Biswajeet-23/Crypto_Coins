...
import com.androidproject.crytpocurrencyapp.adapter.TopGainLossPagerAdapter
import com.androidproject.crytpocurrencyapp.adapter.TopMarketAdapter
import com.androidproject.crytpocurrencyapp.api.ApiInterface
import com.androidproject.crytpocurrencyapp.api.ApiUtilities
import com.androidproject.crytpocurrencyapp.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        imageList.add(SlideModel(R.drawable.crypto))
        imageList.add(SlideModel(R.drawable.crypto2))
        imageList.add(SlideModel(R.drawable.crypto3))
        imageList.add(SlideModel(R.drawable.crypto4))
    ...
    private fun getTopCurrencyList(){
        lifecycleScope.launch(Dispatchers.IO){
            ...
            Log.d("BIS", "getTopCurrencyList: ${res.body()!!.data.cryptoCurrencyList}")
        }
    }
}