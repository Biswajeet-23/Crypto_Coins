...
import com.androidproject.crytpocurrencyapp.databinding.FragmentDetailsBinding
...
class DetailsFragment : Fragment() {
    ...
    private fun loadChartData(
        ...
        binding.detaillChartWebView.loadUrl(
            "https://s.tradingview.com/widgetembed/?frameElementId=tradingview_76d87&symbol" + item.symbol.toString() +
                    ...
                    "[]&hideideas=1&theme=Dark&style=1&timezone=Etc%2FUTC&studies_overrides={}&overrides={}&enabled_features=[]&disabled_features=[]&locale=en&utm_source" +
    ...
    private fun setUpDetails(data: CryptoCurrency) {
        ...
        if(data.quotes[0].percentChange24h > 0){
            ...
            binding.detailChangeTextView.text = "+${String.format("%.05f", data.quotes[0].percentChange24h)} %"
        }
        else{
